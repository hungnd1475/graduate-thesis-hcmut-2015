...
\subsubsection*{Các nguồn tri thức nhân loại}
...
\subsubsection*{Các bộ trích xuất ngữ nghĩa trong văn bản}
...
\emph{Trích xuất thông tin chỉ định của thủ tục y tế (Indicator)}\\
...
\Return{pairs}\;
\end{algorithm}
\caption{Giải thuật chọn lọc các cặp đồng tham chiếu\label{alg:pair-selection}}
\end{figure}
...
\Return{chains}\;
\end{algorithm}
\caption{Giải thuật xây dựng các chuỗi đồng tham chiếu\label{alg:chaining}}
\end{figure}
