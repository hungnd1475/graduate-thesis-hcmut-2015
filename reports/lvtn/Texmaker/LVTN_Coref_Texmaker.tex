...
%\newgeometry{tmargin=2cm,bmargin=2cm,lmargin=3cm,rmargin=2cm}
\pagestyle{fancy}
...
\draw[line width=0.75pt] ($(current page.north west) + (3cm,-2cm)$) rectangle ($(current page.south east) + (-2cm,2cm)$);
\draw[line width=4pt] ($(current page.north west) + (3cm,-2cm) + (3.125pt,-3.125pt)$) rectangle ($(current page.south east) + (-2cm,2cm) + (-3.125pt,3.125pt)$);
\end{tikzpicture}
