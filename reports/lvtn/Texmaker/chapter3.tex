...
Phân định cụm từ là tác vụ phân tích câu văn thành các cụm động từ, cụm giới từ, cụm danh từ hay cụm trạng từ, ... cấu thành nên câu văn đó. Ví dụ trong câu văn \texttt{"The patient is a 47 years old male"} được phân đoạn thành ba cụm: cụm danh từ \texttt{"The patient"}, cụm động từ \texttt{"is"} và cụm danh từ \texttt{"a 47 years old male"}. Vai trò cũng như loại của cụm từ được định nghĩa trong tập nhãn Penn TreeBank \cite{Santorini1990}. Các cụm từ được mô tả theo định dạng IBO giúp xác định vị trí của từ đang xét trong cụm, trong đó B chỉ tới những từ nằm ở đầu cụm, I chỉ tới những từ nằm trong cụm nhưng không phải là từ đầu tiên, O chỉ tới những từ nằm ngoài cụm. Ví dụ cụm danh từ \texttt{"a 47 years old"} viết lại theo định dạng IBO là \texttt{"a|B", "47|I", "years|I", "old|I"}.
