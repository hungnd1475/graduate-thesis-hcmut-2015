...
\item Dòng 7 mô tả cụm từ \texttt{"been"} không được tìm thấy bất kì ứng cử viên nào.
\item Các dòng từ 9 trở đi mô tả kết quả cho cụm từ \texttt{"HIV positive for two years"} với một ứng cử viên có độ tin cậy 875. Ứng cử viên này bao gồm ba khái niệm là \texttt{"positive for HIV"} mang mã số khái niệm là C0019699, \texttt{"two"} mang mã số khái niệm là C0205448 và \texttt{"years"} mang mã số khái niệm là C0439234. 
\end{itemize}
