...
\begin{tikzpicture}[%
	...
	node distance=2.6cm and 0.8cm,
	every join/.style={->, draw},
	font=\scriptsize\sffamily]
	\tikzset{
		bproc/.style = {draw, rectangle, on chain, on grid, text width=2.3cm, minimum height=1.2cm, inner sep=0.5mm, align=center}
	};
	...
	\node[cylinder, minimum width=1.3cm, minimum height=1.2cm, draw, shape border rotate=90, below=0.7cm of map,shape aspect=.4](umls){UMLS};
	
	\draw[->] (sta.south) -- ++(down:0.7cm) -| (vgp.north);	
