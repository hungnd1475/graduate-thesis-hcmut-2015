...
\begin{tikzpicture}[%
	...
	\node[cylinder, minimum width=1.2cm, minimum height=1.1cm, draw, shape border rotate=90, below=0.5cm of map,shape aspect=.4](umls){UMLS};
	
	\draw[->] (sta.south) -- ++(down:0.5cm) -| (vgp.north);	
	\draw[dashed] ($(tkn.north west)+(-0.25,0.25)$) rectangle ($(sta.south east)+(0.25,-0.25)$);
