...
namespace emr_corefsol_service.Controllers
{
    ...
    public class ExtractorController : ApiController
    {
        ...
        [ActionName("Temporal")]
        [HttpPost]
        public CustomResponse PostTemporalDate(TemporalRequest tempRequest)
        {
            var date = TEMPORAL_HELPER.GetTemporalValue(tempRequest.Path, tempRequest.Line, tempRequest.Section);
