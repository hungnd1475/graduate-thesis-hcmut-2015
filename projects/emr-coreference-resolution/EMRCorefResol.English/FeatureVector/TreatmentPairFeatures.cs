...
namespace HCMUT.EMRCorefResol.English
{
    ...
    class TreatmentPairFeatures : FeatureVector
    {
            ...
            : base(size: 21, classValue: classValue)
        {
            ...
            this[12] = new SentenceDistanceFeature(instance);
            this[13] = new ArticleFeature(instance);
            this[14] = new HeadNounFeature(instance);
            this[15] = new ContainFeature(instance);
            this[16] = new CapitolMatchFeature(instance);
            this[17] = new SubstringFeature(instance);
            this[18] = new CosineDistanceFeature(instance);
