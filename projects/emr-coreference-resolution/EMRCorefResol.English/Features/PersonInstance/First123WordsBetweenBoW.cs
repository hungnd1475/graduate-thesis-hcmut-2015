...
namespace HCMUT.EMRCorefResol.English.Features
{
    ...
    class First123WordsBetweenBoW : Feature
    {
        public First123WordsBetweenBoW(PersonInstance instance, EMR emr, ConceptType c2Type,
            IKeywordDictionary keywords)
            : base("First-123-Words-Between-" + c2Type.ToString(), keywords.Count, 0)
        {
